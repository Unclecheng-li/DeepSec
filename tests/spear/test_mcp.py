...
class TestMCPRegistry:
    ...
    def test_register_server(self):
        from deepsec.mcp.registry import MCPRegistry
...
class TestMCPRouter:
    ...
    def test_route_fetch(self):
        from deepsec.mcp.router import MCPRouter
...
class TestMCPLifecycleManager:
    ...
    def test_fetch_falls_back_to_local_mode_when_sdk_attach_fails(self):
        from deepsec.config.schema import BUILTIN_MCP_SERVERS, MCPServerConfig, VulnClawConfig
        from deepsec.mcp.lifecycle import MCPLifecycleManager
    ...
    def test_sse_placeholder_records_invalid_url_error(self):
        from deepsec.config.schema import MCPServerConfig, MCPTransportConfig, VulnClawConfig
        from deepsec.mcp.lifecycle import MCPLifecycleManager
...
class TestStructuredToolResults:
    ...
    async def test_tool_call_manager_preserves_structured_content(self):
        from deepsec.spear.agent.tool_call_manager import handle_tool_calls_with_results
