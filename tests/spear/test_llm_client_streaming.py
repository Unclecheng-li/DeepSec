...
class TestNullSink:
    ...
    def test_null_sink_on_status(self):
        ...
        from deepsec.spear.agent.llm_client import _NullSink
...
class TestCallLlmStream:
    ...
    async def test_stream_tokens_accumulated(self):
        ...
        from deepsec.spear.agent.llm_client import call_llm_stream
...
class TestTerminalStreamSinkRealOutput:
    ...
    def test_sink_outputs_status(self):
        ...
        from deepsec.spear.legacy_cli.main import TerminalStreamSink
    ...
    def test_solve_event_printer_prints_payload_as_plain_text(self):
        ...
        from deepsec.spear.legacy_cli.main import _make_solve_event_printer
...
class TestCallLlmAutoStream:
    ...
    async def test_auto_stream_handles_tool_calls(self):
        """测试工具调用被正确处理"""
        from deepsec.spear.agent.llm_client import call_llm_auto_stream
        ...
        import deepsec.spear.agent.llm_client as llm_client_module
