...
class TestCLI:
    ...
    def test_cli_version(self, runner):
        from deepsec import __version__
        from deepsec.spear.legacy_cli.main import app
    ...
    def test_cli_kb_update(self, runner, monkeypatch, tmp_path):
        import deepsec.kb.store as kb_store
        from deepsec.spear.legacy_cli.main import app
    ...
    def test_recon_resumes_target_state(self, runner, monkeypatch, tmp_path):
        import deepsec.spear.orchestrator as orchestrator_mod
        import deepsec.target_state.store as store_mod
        from deepsec.spear.agent.context import PentestPhase, SessionState
        from deepsec.spear.legacy_cli.main import app
    ...
    def test_repl_persistent_explicit_target_restores_history(self, runner, monkeypatch):
        import deepsec.spear.agent.core as agent_core
        import deepsec.spear.legacy_cli.main as cli_main
        import deepsec.mcp.lifecycle as lifecycle_mod
        from deepsec.spear.agent.context import PentestPhase, SessionState
        from deepsec.spear.legacy_cli.main import app
    ...
    def test_run_engine_team_routes_to_team_supervisor(self, runner, monkeypatch):
        ...
        import deepsec.spear.agent.team as team
        import deepsec.spear.legacy_cli.main as cli_main
        from deepsec.spear.legacy_cli.main import app
        from deepsec.config.schema import VulnClawConfig
    ...
    def test_cli_blocks_command_when_allowed_actions_conflict(self, runner, monkeypatch):
        import deepsec.spear.legacy_cli._helpers as helpers_mod
        import deepsec.spear.legacy_cli.main as cli_main
        from deepsec.spear.legacy_cli.main import app
        from deepsec.config.schema import VulnClawConfig
    ...
    def test_tui_once_renders_target_overview(self, runner, monkeypatch):
        import deepsec.spear.legacy_cli.tui as tui_mod
        from deepsec.spear.legacy_cli.main import app
    ...
    def test_textual_slash_dot_flag_dispatch_applies_state(self):
        import deepsec.spear.legacy_cli.tui as tui_mod
        import deepsec.spear.legacy_cli.tui_textual as textual_mod
    ...
    def test_tui_runtime_diagnostic_panel_renders_environment_summary(self, monkeypatch):
        ...
        import deepsec.mcp.diagnostics as mcp_diag_mod
...
class TestClassicReplSlashPalette:
    ...
    def test_completer_offers_commands_and_skills_on_bare_slash(self):
        ...
        from deepsec.spear.legacy_cli.tui import build_repl_slash_completer, list_repl_palette_entries
    ...
    def test_completion_style_keeps_terminal_background(self):
        from deepsec.spear.legacy_cli.tui import build_repl_slash_style
    ...
    def test_completer_stops_after_skill_is_chosen(self):
        ...
        from deepsec.spear.legacy_cli.tui import build_repl_slash_completer
    ...
    def test_prompt_session_is_none_without_a_tty(self, monkeypatch):
        import deepsec.spear.legacy_cli.main as main_mod
    ...
    def test_language_switch_updates_config(self, monkeypatch):
        import deepsec.spear.legacy_cli.main as main_mod
        import deepsec.spear.legacy_cli.tui as tui_mod
        import deepsec.i18n as i18n_mod
