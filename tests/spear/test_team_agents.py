...
def test_role_registry_defines_seed_roles_as_data():
    from deepsec.spear.agent.roles import ROLE_REGISTRY
...
def test_planner_validates_plan_and_falls_back_on_malformed_output():
    from deepsec.spear.agent.team import validate_plan
...
async def test_make_team_plan_uses_adviser_role_and_json_extraction(monkeypatch):
    from deepsec.spear.agent import solver
    from deepsec.spear.agent.team import make_team_plan
...
async def test_run_team_pentest_runs_roles_and_merges_worker_state():
    from deepsec.spear.agent.team import TeamPlan, TeamStep, run_team_pentest
...
async def test_adviser_replans_are_bounded():
    from deepsec.spear.agent.team import TeamDecision, TeamPlan, TeamStep, run_team_pentest
