...
from deepsec.spear.run_context import (
    RunCollisionError,
    RunCorruptError,
    atomic_write_text,
    create_run_context,
...
from deepsec.spear.targets import legacy_target_state_key, parse_target
...
def test_atomic_write_text_skips_directory_fsync_when_unsupported(tmp_path, monkeypatch):
    import deepsec.spear.run_context as run_context
...
def test_run_aware_save_writes_current_snapshot_and_index(tmp_path, monkeypatch):
    import deepsec.target_state.store as store
