...
class TestPentestPhase:
    ...
    def test_phase_values(self):
        from deepsec.spear.agent.context import PentestPhase
...
class TestVulnerabilityFinding:
    ...
    def test_default_values(self):
        from deepsec.spear.agent.context import VulnerabilityFinding
...
class TestSessionState:
    ...
    def test_save_and_load(self, tmp_path):
        from deepsec.spear.agent.context import PentestPhase, SessionState, VulnerabilityFinding
...
class TestContextManager:
    ...
    def test_session_state_access(self):
        from deepsec.spear.agent.context import ContextManager, PentestPhase
...
class TestTargetState:
    ...
    def test_target_state_resume_strategy_exposes_recon_priority_targets(
        ...
        import deepsec.target_state.store as store_mod
        from deepsec.spear.agent.context import SessionState
        from deepsec.spear.agent.runtime_state import RuntimeState
...
class TestMemoryStore:
    ...
    def test_save_and_retrieve(self, tmp_path):
        from deepsec.spear.agent.memory import MemoryStore
...
class TestPromptBuilder:
    ...
    def test_basic_prompt(self):
        from deepsec.spear.agent.prompts import build_system_prompt
...
class TestAgentCore:
    ...
    async def test_persistent_pentest_keeps_constraints_in_followup_cycles(self):
        ...
        async def _fake_auto_pentest(*args, **kwargs):
            ...
            from deepsec.spear.agent.runtime_state import AgentResult
    ...
    def test_reset_runtime_state_preserves_existing_constraints_when_new_input_has_none(self):
        from deepsec.spear.agent.context import PentestPhase, TaskConstraints
...
class TestAgentCoreLoop:
    ...
    def test_llm_client_uses_max_completion_tokens_for_gpt5_models(self):
        from deepsec.spear.agent.llm_client import build_chat_completion_kwargs
    ...
    async def test_generate_attack_summary_uses_gpt5_token_parameter(self):
        from deepsec.spear.agent.context import SessionState
        from deepsec.spear.agent.prompt_context import generate_attack_summary
    ...
    async def test_llm_client_call_llm_auto_uses_shared_helper(self, monkeypatch):
        from deepsec.spear.agent import llm_client
    ...
    async def test_auto_pentest_stops_on_done_signal(self, monkeypatch):
        agent = self._make_agent()
        from deepsec.spear.agent import loop_controller
    ...
    def test_constraint_policy_normalizes_actions_and_validates_phase(self):
        from deepsec.spear.agent.constraint_policy import (
            infer_tool_action,
