...
class TestWebServices:
    def test_constraint_audit_service_aggregates_events(self, monkeypatch, tmp_path):
        import deepsec.target_state.store as store_mod
        from deepsec.spear.agent.context import SessionState
        from deepsec.web.services.constraint_audit_service import get_constraint_audit
        ...
        monkeypatch.setattr("deepsec.web.services.constraint_audit_service.TARGETS_DIR", tmp_path)
    ...
    def test_web_mcp_service_view(self):
        from deepsec.web.services.mcp_service import get_mcp_diagnostics
    ...
    def test_web_config_service(self):
        from deepsec.web.services.config_service import get_public_config
    ...
    def test_web_config_service_updates_subset(self, monkeypatch, tmp_path):
        import deepsec.web.services.config_service as config_service
        from deepsec.config.schema import VulnClawConfig
        from deepsec.web.schemas import ConfigUpdateRequest
    ...
    def test_web_provider_service_lists_presets(self):
        from deepsec.web.services.provider_service import get_provider_presets
    ...
    def test_web_provider_service_fetch_models_uses_saved_key(self, monkeypatch):
        import deepsec.web.services.provider_service as provider_service
        from deepsec.config.schema import VulnClawConfig
        from deepsec.web.schemas import ProviderModelsRequest
    ...
    def test_web_target_service_lists_targets(self, monkeypatch, tmp_path):
        import deepsec.target_state.store as store_mod
        import deepsec.web.services.target_service as target_service
        from deepsec.spear.agent.context import SessionState, VulnerabilityFinding
    ...
    def test_web_target_service_preview_and_diff(self, monkeypatch, tmp_path):
        import deepsec.target_state.store as store_mod
        import deepsec.web.services.target_service as target_service
        from deepsec.spear.agent.context import SessionState, TaskConstraints, VulnerabilityFinding
    ...
    def test_web_report_service_generates_target_report(self, monkeypatch, tmp_path):
        import deepsec.target_state.store as store_mod
        import deepsec.web.services.report_service as report_service
        from deepsec.spear.agent.context import SessionState, VulnerabilityFinding
    ...
    async def test_web_task_manager_event_flow(self):
        from deepsec.web.schemas import TaskCreateRequest
        from deepsec.web.task_manager import WebTaskManager
    ...
    def test_web_task_prompt_includes_explicit_constraints(self):
        from deepsec.web.schemas import TaskCreateRequest, TaskOptions
        from deepsec.web.services.task_service import _build_prompt_v2
    ...
    def test_web_task_options_reject_invalid_only_port(self):
        ...
        from deepsec.web.schemas import TaskOptions
    ...
    def test_web_task_manager_persists_and_restores_tasks(self, monkeypatch, tmp_path):
        import deepsec.web.task_manager as task_manager_mod
        from deepsec.web.schemas import TaskCreateRequest
    ...
    async def test_web_task_service_restore_summary_flow(self, monkeypatch):
        import deepsec.web.services.task_service as task_service
        from deepsec.spear.agent.context import SessionState
        from deepsec.config.schema import VulnClawConfig
        from deepsec.web.schemas import TaskCreateRequest
        from deepsec.web.task_manager import WebTaskManager
    ...
    async def test_orchestrator_shared_run_flow(self, monkeypatch):
        import deepsec.spear.orchestrator as orchestrator
        from deepsec.spear.agent.context import SessionState
    ...
    def test_web_stream_encode(self):
        from deepsec.web.schemas import TaskEvent
        from deepsec.web.stream import encode_sse
...
class TestWebApp:
    def test_constraint_audit_route_works_without_fastapi(self, monkeypatch):
        import deepsec.web.app as web_app
    ...
    def test_web_schema_rejects_unsafe_config_values(self):
        ...
        from deepsec.web.schemas import ConfigUpdateRequest, ProviderModelsRequest
    ...
    def test_cli_web_allows_loopback_aliases_in_dry_run(self):
        from deepsec.spear.legacy_cli.main import app
    ...
    def test_web_target_preview_and_diff_endpoints(self, monkeypatch):
        import deepsec.web.app as web_app
        import deepsec.web.auth as web_auth
