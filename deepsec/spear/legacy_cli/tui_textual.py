...
import deepsec.spear.legacy_cli.tui as _tui
...
from deepsec.spear.skills.flag_skills import complete_flag_skills, render_flag_skill
...
class DashboardScreen(Screen):
    ...
    def _run_subprocess(self, draft: Any, nl_text: str | None = None) -> None:
        ...
        from deepsec.spear.legacy_cli.tui import build_command_preview_args

        cmd_args = build_command_preview_args(draft, nl_text=nl_text)
        args = [sys.executable, "-m", "deepsec.spear.legacy_cli.main"] + cmd_args[1:]
