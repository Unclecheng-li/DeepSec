...
from deepsec.config.cli_constants import (
    ACTION_NAMES,
    COMMANDS,
    COMMON_TASK_FLAGS,
    ROOT_OPTIONS,
...
def _render_text(topics: tuple[ManualTopic, ...], topic: str) -> str:
    ...
    lines.extend(
        [
            ...
            "  Config directory: ~/.deepsec by default, or DEEPSEC_CONFIG_DIR when set.",
            "  High-value env vars: DEEPSEC_LLM_API_KEY, DEEPSEC_LLM_API_KEYS,",
            "  DEEPSEC_LLM_PROVIDER, DEEPSEC_LLM_BASE_URL, DEEPSEC_LLM_MODEL,",
            "  DEEPSEC_SESSION_OUTPUT_DIR, DEEPSEC_SESSION_MAX_ROUNDS,",
            "  DEEPSEC_SESSION_SHOW_THINKING, DEEPSEC_SAFETY_PYTHON_EXECUTE_ENABLED.",
            "",
            "SAFETY",
...
def _render_markdown(topics: tuple[ManualTopic, ...], topic: str) -> str:
    ...
    lines.extend(
        [
            ...
            "Config directory: `~/.deepsec` by default, or `DEEPSEC_CONFIG_DIR` when set.",
            "",
            "High-value env vars: `DEEPSEC_LLM_API_KEY`, `DEEPSEC_LLM_API_KEYS`, `DEEPSEC_LLM_PROVIDER`, `DEEPSEC_LLM_BASE_URL`, `DEEPSEC_LLM_MODEL`, `DEEPSEC_SESSION_OUTPUT_DIR`, `DEEPSEC_SESSION_MAX_ROUNDS`, `DEEPSEC_SESSION_SHOW_THINKING`, `DEEPSEC_SAFETY_PYTHON_EXECUTE_ENABLED`.",
            "",
            "## Safety",
            "",
