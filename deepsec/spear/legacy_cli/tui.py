...
from deepsec.config.schema import (
    BUILTIN_MCP_SERVERS,
    MCPServerConfig,
    MCPTransportConfig,
)
...
from deepsec.i18n import _, init_i18n
from deepsec.spear.skills.dispatcher import SkillDispatcher
from deepsec.spear.skills.flag_skills import (
...
from deepsec.target_state.store import get_target_state_preview, list_target_snapshots
...
def run_tui(
    *,
    ...
    from deepsec.spear.legacy_cli.tui_textual import run_tui_textual
...
def _cmd_report(session: dict[str, Any], args: str) -> None:
    ...
    from deepsec.spear.legacy_cli.main import _generate_report_for_target
...
def _default_launcher(draft: TuiTaskDraft) -> None:
    from deepsec.spear.legacy_cli import main as cli_main
