...
from deepsec.spear.agent.anti_loop import (
    detect_attack_path,
...
from deepsec.spear.agent.builtin_tools import (
    BLOCKED_PATTERNS,
    RESERVED_IP_RANGES,
    build_openai_tools,
    execute_mcp_tool,
...
from deepsec.spear.agent.context import ContextManager, PentestPhase, SessionState, TaskConstraints
from deepsec.spear.agent.ctf_mode import detect_flag_claim
from deepsec.spear.agent.finding_parser import FindingParser
from deepsec.spear.agent.input_analysis import (
    detect_phase,
    detect_target,
...
from deepsec.spear.agent.kb_context import build_kb_context
from deepsec.spear.agent.llm_client import StreamSink, call_llm
from deepsec.spear.agent.loop_controller import auto_pentest as run_auto_pentest
from deepsec.spear.agent.loop_controller import persistent_pentest as run_persistent_pentest
from deepsec.spear.agent.prompt_context import build_round_context, generate_attack_summary
from deepsec.spear.agent.recon_tracker import update_recon_dimension_completion
from deepsec.spear.agent.roles import role_prompt_block
from deepsec.spear.agent.runtime_state import AgentResult, PersistentCycleResult, RuntimeState
from deepsec.spear.agent.skill_context import apply_skill_selection
from deepsec.spear.agent.system_prompt import build_dynamic_system_prompt
from deepsec.spear.agent.tool_call_manager import safe_parse_tool_args
from deepsec.config.schema import VulnClawConfig
from deepsec.config.settings import make_openai_client
from deepsec.target_state.store import save_target_state
...
class AgentCore:
    ...
    def _restore_reflexion_history(self) -> None:
        ...
        if not snapshot or reflexion is None:
            return
        try:
            from deepsec.spear.agent.reflexion import ReflexionState
    ...
    def _get_client(self):
        ...
        """
        from deepsec.config.token_provider import load_oauth_tokens, resolve_llm_token
        ...
        if (
            ...
            from deepsec.spear.agent.chatgpt_proxy import ensure_proxy_running
    ...
    def _extract_response(message: Any) -> str:
        ...
        from deepsec.spear.agent.llm_client import extract_response
    ...
    async def solve(
        ...
        *,
        ...
        from deepsec.spear.agent.solver import solve as run_solve
