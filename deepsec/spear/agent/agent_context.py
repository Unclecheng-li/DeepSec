"""The typed seam between :class:`~deepsec.spear.agent.core.AgentCore` and its helpers.
...
if TYPE_CHECKING:
    from deepsec.spear.agent.context import ContextManager, PentestPhase, SessionState
    from deepsec.spear.agent.finding_parser import FindingParser
    from deepsec.spear.agent.llm_client import StreamSink
    from deepsec.spear.agent.runtime_state import AgentResult, RuntimeState
...
class AgentContext(Protocol):
    ...
    protocol. :class:`~deepsec.spear.agent.core.AgentCore` satisfies it structurally;
