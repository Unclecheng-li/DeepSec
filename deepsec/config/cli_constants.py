...
COMMANDS: tuple[ManualTopic, ...] = (
    ...
    ManualTopic(
        ...
        examples=(
            "vulnclaw report ~/.deepsec/sessions/session_001.json",
    ...
    ManualTopic(
        ...
        usage="vulnclaw init",
        notes=(
            "Creates ~/.deepsec by default, unless DEEPSEC_CONFIG_DIR points somewhere else.",
        ),
    ...
    ManualTopic(
        ...
        flags=(
            ...
            ("--format man, -f man", "roff man-page format suitable for saving as deepsec.1."),
        ),
        notes=(
